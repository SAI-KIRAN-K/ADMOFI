...
public class CustomAdapterchartboostv extends CustomAdapterImpl {
	
	private Activity act = null;
	String TAG = "chartboost";
	boolean isCompletecalled = true;
	
	public CustomAdapterchartboostv(Context context) {
		super(context);		
	}
	...
	private void loadInterstitial(Context context, AdmofiAd mAdCurrent) {
		try {
			AdmofiUtil.logMessage(null, Log.DEBUG, "Admofi ChartBoostv loadInterstitial");
	...
	public boolean showinterstitial() {
		try {
			if(getAd().getAdType() == AdmofiConstants.AD_TYPE_INTERSTITIAL) {			
				...
				AdmofiUtil.logMessage(null, Log.DEBUG, "Admofi ChartBoostv ShowInter");
	...
	private ChartboostDelegate delegate = new ChartboostDelegate() {
		...
		public void didCacheRewardedVideo(String location) {
			AdmofiUtil.logMessage(null, Log.DEBUG,"Admofi ChartBoostv didCacheRewardedVideo");
			adEventReady(null);			
		}
	
		@Override
		public void didFailToLoadRewardedVideo(String location,CBImpressionError error) {
			AdmofiUtil.logMessage(null, Log.DEBUG,"Admofi ChartBoostv didFailToLoadRewardedVideo erro :: "+error.name());
		...
		public void didDismissRewardedVideo(String location) {
			AdmofiUtil.logMessage(null, Log.DEBUG,"Admofi ChartBoostv didDismissRewardedVideo ");
		...
		public void didCompleteRewardedVideo(String location, int reward) {			
			...
			//adEventRewardSuccess(new AdmofiReward("points", reward ,true,"Admofi ChartBoostv reward success"));
